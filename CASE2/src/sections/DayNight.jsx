  ...
  return (
    <section ref={ref} style={{ height: '480vh' }} className="relative">
      <div className="sticky top-0 flex h-screen flex-col overflow-hidden">
        ...
        <div className="mx-auto hidden w-full max-w-[1280px] flex-1 items-center px-8 lg:flex lg:gap-12">
          {/* телефон слева, крупный */}
          <motion.div className="relative w-[45%] shrink-0" style={{ filter }}>
            <div className="relative" style={{ perspective: 1600 }}>
              <motion.div style={{ transform: 'rotateY(-8deg) rotateX(3deg)' }}>
                <PhoneMockup width={320} withSphere={false}><ScreenVideo src="/screens/home.mp4"><ScreenHome /></ScreenVideo></PhoneMockup>
              </motion.div>
            </div>
          </motion.div>
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-6 px-5 lg:hidden">
          <motion.div style={{ filter }}>
            <PhoneMockup width={200} withSphere={false}><ScreenVideo src="/screens/home.mp4"><ScreenHome /></ScreenVideo></PhoneMockup>
          </motion.div>
