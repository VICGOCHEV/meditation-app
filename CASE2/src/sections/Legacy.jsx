    ...
    <Sec id="legacy" num="02" tag="Отправная точка" ghost="02">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div className="max-w-xl">
          <Title className="text-[clamp(2rem,5vw,3.4rem)]">Мы не начали<br className="hidden sm:block" /> с пустого листа</Title>
          <Lead className="mt-6">
        ...
        <Up delay={0.1}>
          <LegacyShot phone src="/legacy/old-1.png" caption="Старая версия · скриншот экрана" hint="скриншот старого приложения" />
        </Up>
      </div>
    </Sec>
  )
