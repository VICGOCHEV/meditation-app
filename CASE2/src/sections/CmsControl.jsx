  ...
  return (
    <Sec id="cms" num="13" tag="Custom CMS" ghost="10" wide>
      <div className="max-w-2xl">
        ...
        <Lead className="mt-6">Strapi отклонили — перегружен и неудобен. Собрали собственную CMS под контент именно этого продукта. Смотрите, как практика собирается за четыре шага.</Lead>
      </div>
