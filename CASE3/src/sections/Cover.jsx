  ...
  return (
    <section id="cover" className="relative flex min-h-[100svh] flex-col justify-center overflow-hidden px-5 py-24 sm:px-8">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <img src={`${import.meta.env.BASE_URL}frames/0121.avif`} alt="" className="h-full w-full object-cover opacity-[0.55]" />
        ...
        >
          <Tilt3D rotY={-16} rotX={7}>
            <div className="float-soft relative" style={{ transformStyle: 'preserve-3d' }}>
              ...
              <PhoneMockup width={290}><ScreenVideo src={`${import.meta.env.BASE_URL}screens/home.mp4`}><ScreenHome /></ScreenVideo></PhoneMockup>
