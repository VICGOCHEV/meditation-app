...
const STEPS = [
  { n: '01', t: 'Онбординг', d: 'Мягкий вход: пролог, методология, выбор голоса и музыки. Никакой перегрузки выбором — продукт сразу задаёт состояние.', v: `${import.meta.env.BASE_URL}screens/onboarding.mp4` },
  { n: '02', t: 'Анкетирование', d: 'Четыре вопроса меньше минуты. Приложение считывает текущее состояние и переводит его в Индекс Состояния.', v: `${import.meta.env.BASE_URL}screens/checkin.mp4` },
  { n: '03', t: 'Индекс состояния', d: 'Не голая цифра, а осознанная интерпретация: ясность, поток, туман или шторм — с понятным объяснением.', v: `${import.meta.env.BASE_URL}screens/index.mp4` },
  { n: '04', t: 'Плеер', d: 'Практика с живым голосом и аморфной сферой, дышащей в такт. Без пауз и перемоток — только поток до конца.', v: `${import.meta.env.BASE_URL}screens/player.mp4` },
]
...
function VideoLayer({ src, opacity }) {
  ...
  return <motion.video ref={ref} src={src} autoPlay loop muted playsInline preload="auto" disablePictureInPicture controls={false} className="absolute inset-0 h-full w-full object-cover" style={{ opacity }} />
}
    ...
    <>
      ...
      <section ref={ref} style={{ height: `${N * 100}vh` }} className="relative">
        ...
        <div className="sticky top-0 flex h-screen items-center overflow-hidden">
          <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-center gap-6 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
            {/* телефон крупно, наполовину */}
            <div className="relative flex justify-center lg:justify-start">
              <div className="relative w-[200px] sm:w-[300px] lg:w-auto" style={{ maskImage: 'linear-gradient(180deg,#000 78%,transparent)', WebkitMaskImage: 'linear-gradient(180deg,#000 78%,transparent)' }}>
            ...
            <div className="relative">
              ...
              <div className="relative min-h-[210px] sm:min-h-[280px]">
                {STEPS.map((s, i) => (
