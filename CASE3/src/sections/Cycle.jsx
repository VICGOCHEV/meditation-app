...
// Порт секции «Один цикл — четыре дня» с лендинга: липкая вертикальная жила,
// огонёк по скроллу, пошаговое раскрытие.
const STEPS = [
...
function StepContent({ progress, i, step }) {
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col justify-center" style={{ opacity }}>
      ...
      <motion.div style={{ x }} className="relative z-10 max-w-xl">
...
export default function Cycle() {
  ...
  const sparkStretch = useTransform(scrollYProgress, [0, 0.05, 0.9, 1], [2.4, 1, 1, 2.6])
  ...
  return (
    <section id="cycle" ref={ref} style={{ height: `${N * 100}vh` }} className="relative">
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="mx-auto flex h-full max-w-6xl flex-col justify-start gap-6 px-5 pt-24 pb-20 lg:grid lg:grid-cols-[1fr,auto,1fr] lg:items-center lg:justify-center lg:gap-14 lg:pt-0 lg:pb-0">
          <MouseFloat strength={11} className="relative z-20">
            <SecTag num="08" className="mb-5">Система прогрессии</SecTag>
          ...
          <div className="flex min-h-0 flex-1 items-stretch gap-5 lg:contents">
            <div className="relative h-[40vh] w-9 shrink-0 self-center lg:h-[58vh]">
            ...
            <div className="relative h-[40vh] flex-1 lg:h-[60vh]">
