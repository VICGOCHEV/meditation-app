...
const SLOT_SRC = {
  morning: `${import.meta.env.BASE_URL}preloaders/morning.mp4`,
  day: `${import.meta.env.BASE_URL}preloaders/day.mp4`,
  evening: `${import.meta.env.BASE_URL}preloaders/evening.mp4`,
  night: `${import.meta.env.BASE_URL}preloaders/night.mp4`,
}
